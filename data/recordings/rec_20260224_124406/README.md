...
**录制时间**: 2026年 02月 24日 星期二 12:44:28 CST
**录制时长**: 15秒
**录制模式**: both
...
Bag size:          1.8 MiB
Storage id:        sqlite3
Duration:          18.784343963s
Start:             Feb 24 2026 12:44:09.528557170 (1771908249.528557170)
End:               Feb 24 2026 12:44:28.312901133 (1771908268.312901133)
Messages:          10017
Topic information: Topic: /right_arm_joint_control | Type: sensor_msgs/msg/JointState | Count: 4539 | Serialization Format: cdr
                   Topic: /robot1/right_arm/joint_follow | Type: lbot_arm_interfaces/msg/FollowJoint | Count: 4539 | Serialization Format: cdr
                   Topic: /robot1/right_arm/joint_states | Type: sensor_msgs/msg/JointState | Count: 939 | Serialization Format: cdr
```
...
average rate: 241.677
	min: 0.000s max: 0.014s std dev: 0.00543s window: 2914
average rate: 241.539
	min: 0.000s max: 0.014s std dev: 0.00544s window: 3156

话题: /robot1/right_arm/joint_follow
average rate: 241.766
	min: 0.000s max: 0.015s std dev: 0.00547s window: 2915
average rate: 241.540
	min: 0.000s max: 0.015s std dev: 0.00548s window: 3156

话题: /robot1/right_arm/joint_states
average rate: 49.992
	min: 0.013s max: 0.027s std dev: 0.00296s window: 609
average rate: 50.014
	min: 0.013s max: 0.027s std dev: 0.00294s window: 660
```
...
python scripts/evaluate_vision_performance.py \
    --rosbag /home/ilex/Dev/VIST/data/recordings/rec_20260224_124406/rosbag \
    --config config/evaluation_config.yaml \
    --output /home/ilex/Dev/VIST/data/recordings/rec_20260224_124406/evaluation
