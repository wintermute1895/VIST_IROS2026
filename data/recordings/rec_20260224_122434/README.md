...
**录制时间**: 2026年 02月 24日 星期二 12:24:56 CST
**录制时长**: 15秒
**录制模式**: both
...
Bag size:          1.4 MiB
Storage id:        sqlite3
Duration:          18.508035591s
Start:             Feb 24 2026 12:24:37.834564300 (1771907077.834564300)
End:               Feb 24 2026 12:24:56.342599891 (1771907096.342599891)
Messages:          5405
Topic information: Topic: /right_arm_joint_control | Type: sensor_msgs/msg/JointState | Count: 4479 | Serialization Format: cdr
                   Topic: /robot1/right_arm/joint_states | Type: sensor_msgs/msg/JointState | Count: 926 | Serialization Format: cdr
```
...
average rate: 236.029
	min: 0.000s max: 0.013s std dev: 0.00557s window: 2850
average rate: 236.473
	min: 0.000s max: 0.013s std dev: 0.00557s window: 3093

话题: /robot1/right_arm/joint_follow

话题: /robot1/right_arm/joint_states
average rate: 50.007
	min: 0.011s max: 0.028s std dev: 0.00265s window: 608
average rate: 49.995
	min: 0.011s max: 0.028s std dev: 0.00275s window: 658
```
...
python scripts/evaluate_vision_performance.py \
    --rosbag /home/ilex/Dev/VIST/data/recordings/rec_20260224_122434/rosbag \
    --config config/evaluation_config.yaml \
    --output /home/ilex/Dev/VIST/data/recordings/rec_20260224_122434/evaluation
