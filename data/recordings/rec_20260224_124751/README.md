...
**录制时间**: 2026年 02月 24日 星期二 12:48:13 CST
**录制时长**: 15秒
**录制模式**: both
...
Bag size:          1.7 MiB
Storage id:        sqlite3
Duration:          18.486436690s
Start:             Feb 24 2026 12:47:54.690344316 (1771908474.690344316)
End:               Feb 24 2026 12:48:13.176781006 (1771908493.176781006)
Messages:          9865
Topic information: Topic: /right_arm_joint_control | Type: sensor_msgs/msg/JointState | Count: 4470 | Serialization Format: cdr
                   Topic: /robot1/right_arm/joint_follow | Type: lbot_arm_interfaces/msg/FollowJoint | Count: 4470 | Serialization Format: cdr
                   Topic: /robot1/right_arm/joint_states | Type: sensor_msgs/msg/JointState | Count: 925 | Serialization Format: cdr
```
...
average rate: 241.325
	min: 0.000s max: 0.014s std dev: 0.00550s window: 2916
average rate: 241.408
	min: 0.000s max: 0.014s std dev: 0.00550s window: 3159

话题: /robot1/right_arm/joint_follow
average rate: 241.308
	min: 0.000s max: 0.014s std dev: 0.00553s window: 2916
average rate: 241.399
	min: 0.000s max: 0.014s std dev: 0.00553s window: 3159

话题: /robot1/right_arm/joint_states
average rate: 49.997
	min: 0.013s max: 0.028s std dev: 0.00262s window: 608
average rate: 49.993
	min: 0.013s max: 0.028s std dev: 0.00264s window: 658
```
...
python scripts/evaluate_vision_performance.py \
    --rosbag /home/ilex/Dev/VIST/data/recordings/rec_20260224_124751/rosbag \
    --config config/evaluation_config.yaml \
    --output /home/ilex/Dev/VIST/data/recordings/rec_20260224_124751/evaluation
