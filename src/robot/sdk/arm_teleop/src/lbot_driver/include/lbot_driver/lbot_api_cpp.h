...
public:
     ...
     * @return 版本字符串
     */
    std::string lbot_get_api_version();
     ...
     */
    bool lbot_get_controller_info(lbot_handle_t handle, std::string& robot_model, std::string& controller_version);
     ...
     * @return true 指令发送成功，false 发送失败
     */
    bool lbot_move_joint(lbot_handle_t handle, lbot_arm_t arm, const std::vector<double>& joints, double speed, double accel, bool block);
     ...
     * @return true 指令发送成功，false 发送失败
     */
    bool lbot_move_pose(lbot_handle_t handle, lbot_arm_t arm, const std::vector<double>& position, const std::vector<double>& euler,
                       double speed, double accel, bool block);
     ...
     * @return true 指令发送成功，false 发送失败
     */
    bool lbot_move_linear(lbot_handle_t handle, lbot_arm_t arm, const std::vector<double>& position, const std::vector<double>& euler,
                         double speed, double accel, bool block);
     ...
     * @return true 指令发送成功，false 发送失败
     */
    bool lbot_joint_follow(lbot_handle_t handle, lbot_arm_t arm, const std::vector<double>& joints, bool follow);
     ...
     * @return true 指令发送成功，false 发送失败
     */
    bool lbot_l6_set_position(lbot_handle_t handle, lbot_arm_t arm, const std::vector<uint8_t>& position);
     ...
     * @return true 指令发送成功，false 发送失败
     */
    bool lbot_l6_set_velocity(lbot_handle_t handle, lbot_arm_t arm, const std::vector<uint8_t>& velocity);
     ...
     * @return true 指令发送成功，false 发送失败
     */
    bool lbot_l6_set_effort(lbot_handle_t handle, lbot_arm_t arm, const std::vector<uint8_t>& torque);
     ...
     * @return true 指令发送成功，false 发送失败
     */
    bool lbot_l10_set_position(lbot_handle_t handle, lbot_arm_t arm, const std::vector<uint8_t>& position);
     ...
     * @return true 指令发送成功，false 发送失败
     */
    bool lbot_l10_set_velocity(lbot_handle_t handle, lbot_arm_t arm, const std::vector<uint8_t>& velocity);
     ...
     * @return true 指令发送成功，false 发送失败
     */
    bool lbot_l10_set_effort(lbot_handle_t handle, lbot_arm_t arm, const std::vector<uint8_t>& torque);
     ...
     * @return true 计算成功，false 计算失败
     */
    bool lbot_forward_kinematics(lbot_handle_t handle, lbot_arm_t arm, const std::vector<double>& joints,
     ...
     * @return true 求解成功，false 求解失败
     */
    bool lbot_inverse_kinematics(lbot_handle_t handle, lbot_arm_t arm, const std::vector<double>& initial_joints,
     ...
     * @return true 设置成功，false 设置失败
     */
    bool lbot_set_tool_frame(lbot_handle_t handle, lbot_arm_t arm, const std::string& name,
                            const std::vector<double>& position, const std::vector<double>& euler);
     ...
     * @return true 获取成功，false 获取失败
     */
    bool lbot_get_tool_frame(lbot_handle_t handle, lbot_arm_t arm, const std::string& name,
                            std::vector<double>& position, std::vector<double>& euler);
     ...
     * @return true 获取成功，false 获取失败
     */
    bool lbot_get_current_tool_frame(lbot_handle_t handle, lbot_arm_t arm,                                     std::string& name,
     ...
     * @return true 切换成功，false 切换失败
     */
    bool lbot_change_tool_frame(lbot_handle_t handle, lbot_arm_t arm, const std::string& name);
     ...
     * @return true 删除成功，false 删除失败
     */
    bool lbot_delete_tool_frame(lbot_handle_t handle, lbot_arm_t arm, const std::string& name);
     ...
     * @return true 获取成功，false 获取失败
     */
    bool lbot_get_all_tool_frames(lbot_handle_t handle, lbot_arm_t arm, std::vector<std::string>& names);
     ...
     * @return true 设置成功，false 设置失败
     */
    bool lbot_set_work_frame(lbot_handle_t handle, lbot_arm_t arm, const std::string& name,
                            const std::vector<double>& position, const std::vector<double>& euler);
     ...
     * @return true 获取成功，false 获取失败
     */
    bool lbot_get_work_frame(lbot_handle_t handle, lbot_arm_t arm, const std::string& name,
                            std::vector<double>& position, std::vector<double>& euler);
     ...
     * @return true 切换成功，false 切换失败
     */
    bool lbot_change_work_frame(lbot_handle_t handle, lbot_arm_t arm, const std::string& name);
     ...
     * @return true 删除成功，false 删除失败
     */
    bool lbot_delete_work_frame(lbot_handle_t handle, lbot_arm_t arm, const std::string& name);
     ...
     * @return true 获取成功，false 获取失败
     */
    bool lbot_get_all_work_frames(lbot_handle_t handle, lbot_arm_t arm, std::vector<std::string>& names);
     ...
     * @return 错误信息字符串
     */
    std::string lbot_get_last_error(lbot_handle_t handle);
