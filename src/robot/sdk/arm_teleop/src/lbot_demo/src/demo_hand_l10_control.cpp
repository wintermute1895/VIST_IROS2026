...
int main(int argc, char** argv)
{
    ...
    auto node = std::make_shared<rclcpp::Node>("demo_dual_hand_l10_control");
    ...
    /* ================== 设置速度 ================== */
    std::cout << "\n>>> 设置速度（左右手同步）" << std::endl;
    std::vector<uint8_t> speeds = {250, 250, 250, 250, 250, 250, 250, 250, 250, 250};
    ...
    /* ================== 设置扭矩 ================== */
    std::cout << "\n>>> 设置扭矩（左右手同步）" << std::endl;
    std::vector<uint8_t> torques = {250, 250, 250, 250, 250, 250, 250, 250, 250, 250};
    ...
    // 控制参数：拇指根部 拇指侧摆 食指根部 中指根部 无名指根部 小拇指根部 食指侧摆 无名指侧摆 小指侧摆 拇指旋转
    for (int i = 0; i < 10; ++i)
    {
        std::cout << "\n===== 第 " << i + 1 << " 次 =====" << std::endl;

        /* ---------- 第一阶段 ---------- */
        std::vector<uint8_t> pos0 = {250, 128, 250, 250, 250, 250, 128, 128, 128, 250};
        ...
        /* ---------- 第二阶段 ---------- */
        std::vector<uint8_t> pos250 = {100, 128, 10, 10, 10, 10, 128, 128, 128, 250};
