...
bool lbot_arm_interfaces__msg__follow_joint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lbot_arm_interfaces.msg._follow_joint.FollowJoint", full_classname_dest, 49) == 0);
  }
  lbot_arm_interfaces__msg__FollowJoint * ros_message = _ros_message;
  {  // joints
...
PyObject * lbot_arm_interfaces__msg__follow_joint__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("lbot_arm_interfaces.msg._follow_joint");
